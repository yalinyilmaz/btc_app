...
Testler; response parsing, repository cache ve hata eşleme davranışı, Cubit state geçişleri, favorilerin serialize edilmesi, filtreleme, arama, responsive liste oluşturma, grafik aralığı istekleri, chart etkileşimi ve küçük ekranda scroll davranışını kapsıyor.
